...
(function () {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      "bridge.list1__html": "A publisher serves an <code>llms.txt</code> whose <code>## Skills</code> section lists each executable skill with its <code>tool.js</code> and <code>tool_sha256</code> — mirrored in <code>/.well-known/agent-skills/index.json</code> and signed in <code>attestations.json</code>. This is exactly what this spec defines.",
    ...
    es: {
      ...
      "bridge.list1__html": "Un publicador sirve un <code>llms.txt</code> cuya sección <code>## Skills</code> lista cada skill ejecutable con su <code>tool.js</code> y su <code>tool_sha256</code> — reflejado en <code>/.well-known/agent-skills/index.json</code> y firmado en <code>attestations.json</code>. Esto es exactamente lo que define esta spec.",
    ...
    pt: {
      ...
      "bridge.list1__html": "Um publicador serve um <code>llms.txt</code> cuja seção <code>## Skills</code> lista cada skill executável com seu <code>tool.js</code> e seu <code>tool_sha256</code> — espelhado em <code>/.well-known/agent-skills/index.json</code> e assinado em <code>attestations.json</code>. É exatamente o que esta spec define.",
