...
| Opción | Analogía | Problema |
|---|---|---|
| **MCP** | El electricista necesita una línea directa de teléfono contigo, 24/7, con protocolos de seguridad, autenticación, y un contrato de mantenimiento. | Correcto para una fábrica. Absurdo para cambiar un bombillo. |
| **/.well-known/skills/** | Dejas una copia de las instrucciones en un buzón público con una dirección fija. | Solo cabe un juego de instrucciones. Si tu casa tiene electricidad *y* plomería, solo puedes dejar uno. |
| **Nada** | El electricista lee el folleto promocional de tu casa (llms.txt) pero no sabe que existen instrucciones técnicas. Se queda adivinando dónde está el tablero. | Frustrante para ambos. |
| **## Skills en llms.txt** *(propuesta)* | El folleto promocional *incluye* una sección: "Aquí están las instrucciones técnicas para electricidad, plomería, y jardinería." | Una sola visita, todo descubierto, sin infraestructura extra. |
