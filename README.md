...
> Draft v0.9 — Especificación para publicar y consumir Agent Skills a través de `llms.txt`.
...
- **RFC v0.9**: especificación completa del protocolo
...
├── .gitignore
├── docs/
│   ├── rfc-skills-in-llms-txt.md     # RFC completo (v0.9)
